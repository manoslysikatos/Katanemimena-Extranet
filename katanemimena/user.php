...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user" id="exampleFirstName" value="<?php echo $_SESSION["firstName"]?>"
                            placeholder="Πληκτρολογήστε..." disabled>
                    </div>
                    <div class="col-sm-6">
                        <label for="lastname">Επώνυμο:</label>
                        <input type="text" class="form-control form-control-user" id="exampleLastName" value="<?php echo $_SESSION["lastName"]?>"
                            placeholder="Πληκτρολογήστε..." disabled>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <input type="tel" id="phone" name="phone" placeholder="123-45-678" value="<?php echo $_SESSION["tel"]?>" class="form-control form-control-user"
 ...
 <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="email" class="form-control form-control-user" id="exampleInputEmail" value="<?php echo $_SESSION["email"]?>"
